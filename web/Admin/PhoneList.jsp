...
<html class="x-admin-sm">
    ...
    <div class="layui-card-body ">
        <table class="layui-table" lay-data="{url:'${pageContext.request.contextPath}/back/BackServlet?flag=getProductListbyType_id',page:true,where:{type_id: 1},id:'test',limit:5,limits:[5,10,15],toolbar: '#toolbarDemo'  }" lay-filter="test">
            <thead>
            <tr>
