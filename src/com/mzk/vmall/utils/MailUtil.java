...
public class MailUtil {
    ...
    private static String mailSenderAddress = "miao_zhenkai@126.com";
    private static String mailSenderNick = "Vmall商城";
    private static String mailSenderUsername = "miao_zhenkai@126.com";
    private static String mailSenderPassword = "Mzk030712";
